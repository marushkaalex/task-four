...
public class ConnectionPool {
    ...
    private ConnectionPool(Properties properties) throws ConnectionPoolException {
        try {
            ...
            String uri = properties.getProperty("cp.uri");
            String username = properties.getProperty("cp.username");
            String password = properties.getProperty("cp.password");
            int count = Integer.parseInt(properties.getProperty("cp.count", DEFAULT_COUNT));
